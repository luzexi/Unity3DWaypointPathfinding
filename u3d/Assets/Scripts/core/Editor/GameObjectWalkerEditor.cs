...
/// <summary>
[CustomEditor(typeof(GameObjectWalker))]
public class GameObjectWalkerEditor : Editor
{
	public SerializedObject m_Object;
    // public List<PathNodeEditor> mListEditorNode = new List<PathNodeEditor>();
    ...
    public override void OnInspectorGUI()
    {
        ...
        // EditorGUILayout.PropertyField(mListEditorNode, true);
        EditorGUILayout.PropertyField(m_Object.FindProperty("mPoints"), true);
